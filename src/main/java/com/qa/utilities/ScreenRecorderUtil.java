...
import static org.monte.media.math.Rational.*;
...
public class ScreenRecorderUtil extends ScreenRecorder {
   ...
   /* public static void startRecord(String methodName) throws Exception {
        ...
        Format videoFormat = new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,
                CompressorNameKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, DepthKey, 24, FrameRateKey,
                Rational.valueOf(15), QualityKey, 1.0f,  KeyFrameIntervalKey, 15 * 60);

        // Create the screen recorder with MP4 format
        screenRecorder = new ScreenRecorderUtil(gc, captureSize,
                fileFormat, videoFormat, null,
                null, file, methodName);
        screenRecorder.start();
    }*/
