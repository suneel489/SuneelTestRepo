...
public class TestConfig {
	  ...
	  public static String server = "kumari.ankita@accenture.com"; 
	  public static String from = "kumari.ankita@accenture.com"; 
	  public static String password ="Selenium@123"; 
	  public static String[] to = { "kumari.ankita@accenture.com", "kumari.ankita@accenture.com" }; 
	  ...
	  public static String dbUserName = "sa"; public static String dbPassword = "$ql$!!1";
